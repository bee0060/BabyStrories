...
(function(global) {
	...
	var head = document.getElementsByTagName('head')[0],
		REMOTE_SCRIPT_SRC = ['http://bee0060.github.io/BabyStrories/js/app/common.js',
			'http://bee0060.github.io/BabyStrories/js/app/zip-unzip.js',
			'http://bee0060.github.io/BabyStrories/js/app/single-flag-board-manager.js'
		],
		LOCAL_SCRIPT_SRC = [
			'js/app/common.js',
			'js/app/zip-unzip.js',
			'js/app/single-flag-board-manager.js'
		],
